...
class Gear(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if keystate[pygame.K_w] or keystate[pygame.K_s]:
            self.rotate_up()
...
for i in range(12):
    ...
    explosion = pygame.transform.scale(bullet, (30,30))
...
gear = pygame.transform.scale(gear, (20,20))
...
while running:
    ...
    spawn_time_mob = 2000
    luck_mob = 200
    chiffre_mob = random.randrange(0, luck_bee)
